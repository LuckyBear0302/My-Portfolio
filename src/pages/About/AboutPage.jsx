          ...
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
                <FormattedMessage
                  id="about-info-1"
                  defaultMessage="Hi, I would love to introduce myself as a Professional front-end and back-end web developer, with more than 8+ years of experience building beautiful websites and web apps. I have been developing and managing web applications since 2015 which includes quite varied expertise – creating e-commerce platforms, professional sites, landing pages, etc."
                />
              </p>
              ...
              <div className="hide parrafo-active">
                <p>
                  <FormattedMessage
                    id="about-info-2"
                    defaultMessage="My #1 goal is always to meet your needs and deadlines. My strongest points are my creativity and punctuality. When I am working on a new project, I like to talk with the client so that I can have a clear understanding of his needs and vision of the project."
                  />
                </p>
              </div>
              ...
              <div className="hide parrafo-active">
                <p>
                  <FormattedMessage
                    id="about-info-3"
                    defaultMessage="I believe the best thing I gained over my vast experience is the ability to work out of my comfort zone. If I don't know something that doesn't mean I can't do it."
                  />
                </p>
              </div>
